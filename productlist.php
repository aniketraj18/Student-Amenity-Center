             ...
             <div class="card ">
                 ...
                 <div class="card-body">
                     <div class="table-responsive ps">
                         <table class="table tablesorter " id="page1">
                             <thead class=" text-primary">
                                 <tr>
                                     ...
                                     <th>Price</th>
                                     <th>
                                         <a class=" btn btn-primary" href="adminpg.php">Add New</a>
                                     </th>
                                 </tr>
                             </thead>
                             <tbody>
                        ...
                        <a class=' btn btn-success' href='productlist.php?product_id=$product_id&action=delete'>Delete $product_id</a>
                        </td></tr>";
                        }
